...
class ImageDialog extends React.Component {
    render() {
        ...
        return (
            <Dialog scroll="body" open={showImage} onClose={onClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
                ...
                <CardActions style={{ justifyContent: 'flex-end' }}>
                    <Button style={{ color: 'red' }} onClick={() => deleteButton(data.id, data.name, _this)}>
                        Delete
                    </Button>
                </CardActions>
            </Dialog>
