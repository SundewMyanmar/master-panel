                                ...
                                <Card className={classes.card}>
                                            ...
                                            <Tooltip title={item.active ? 'This menu is active.' : 'This menu is not active.'} aria-label="isActive">
                                                <Icon
                                                    style={{
                                                        fontSize: '16px',
                                                        color: item.active
                                                            ? this.props.theme.palette.common.green
                                                            : this.props.theme.palette.common.red,
                                                    }}
                                                >
                                                    lens
                                                </Icon>
                                    ...
                                    <CardContent>
                                        <List>
                                            <ListItem>
                                                ...
                                                <ListItemText
                                                    primary={
                                                        <Typography
                                                            variant="body2"
                                                            style={{ textDecoration: item.order_available ? 'none' : 'line-through red' }}
                                                        >
                                                            Order Available
                                                        </Typography>
                                                    }
                                                ...
                                                <ListItemText
                                                    primary={
                                                        <Typography variant="body2">
                                                            {FormatManager.formatDate(item.order_valid_date, 'YYYY/MM/DD (ddd)')}
                                                        </Typography>
                                                    }
                                                />
                                            </ListItem>
                                            <ListItem>
                                                ...
                                                <ListItemText primary={<Typography variant="body2">{item.price} MMK</Typography>} />
                                            </ListItem>
                                            {item.ingredient ? (
                                                <ListItem>
                                    ...
                                    <CardActions>
                                        <Grid container justify="flex-end">
                                            ...
                                            <IconButton
                                                style={{ color: this.props.theme.palette.common.red }}
                                                aria-label="Delete"
                                                onClick={() => deleteButton(item.id, item.name ? item.name : item.display_name, _this, item)}
                                            >
                                                <Icon>delete</Icon>
                                            </IconButton>
                                        </Grid>
